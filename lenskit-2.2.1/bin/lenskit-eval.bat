...
@rem ##########################################################################
@rem
@rem  lenskit-eval startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute lenskit-eval
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LENSKIT_OPTS%  -classpath "%CLASSPATH%" org.grouplens.lenskit.eval.cli.EvalCLI %CMD_LINE_ARGS%
...
:fail
rem Set variable LENSKIT_EVAL_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%LENSKIT_EVAL_EXIT_CONSOLE%" exit 1
exit /b 1
